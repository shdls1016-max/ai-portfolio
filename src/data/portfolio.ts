...
export const games: GameProject[] = [
  {
    ...
    image: '/images/projects/crossing-journey.png',
  ...
  },
  {
    ...
    duration: '약 2일 · 25시간',
    image: '/images/projects/starbound-steps.png',
...
export const landingProjects: LandingProject[] = [
  {
    ...
    duration: '약 3일',
    image: '/images/projects/landing-vitamin.png',
  ...
  },
  {
    ...
    duration: '약 4일',
    image: '/images/projects/landing-english.png',
...
export const detailProjects: DetailProject[] = [
  ...
  },
  {
    ...
    intent: 'AI 와이어프레임과 메인 이미지를 살리면서 수분 지속력과 피부 변화를 근거 중심으로 전달했습니다.',
    flow: ['핵심 효능', '피부 고민', '수분 기술', '원료', '사용 경험', '구매 제안'],
    aiMode: 'AI Draft + Figma Refinement',
    directWork: ['타이포그래피 재정리', '간격·정렬 보완', '이미지 배치 수정', '컬러와 섹션 흐름 통일'],
    duration: '약 2일',
  ...
  },
  {
    ...
    intent: 'AI 기획과 무드, 이미지를 바탕으로 정보량을 줄이고 제품 장점이 빠르게 읽히도록 Figma에서 다시 설계했습니다.',
    flow: ['착석 문제', '사용 장면', '맞춤 조절', '소재와 내구성', '사용자 후기', '제품 규격'],
    aiMode: 'AI Planning + Figma Redesign',
    directWork: ['깨진 이미지 보완', '전체 레이아웃 재설계', '폰트·정렬 수정', '과도한 정보 삭제', '이미지 위치 조정'],
    duration: '약 1–2일',
